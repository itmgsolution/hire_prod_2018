...
<div align="center">
  <strong>สถานการณ์การจ้างงานคนพิการในสถานประกอบการภาคเอกชนและในหน่วยงานภาครัฐ <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?></strong>
              <br>
</div>
...
<table border="1" align="center" cellpadding="5" cellspacing="0" style="font-size:14px; display: none;">
   	  <thead>
      ...
      <tr >
        ...
        <td colspan="13" align="center" ><div align="center"><strong>นายจ้างหรือสถานประกอบการ</strong></div></td>
        </tr>
      <tr >
        ...
        <div align="center"><strong>
          อัตราส่วนที่ต้อง<br />
          รับคนพิการเข้า<br />
          ทํางาน(ราย) </strong></div>        </td>
        <td colspan="10" align="center" valign="top" ><div align="center"><strong>การปฏิบัติตามกฎหมาย </strong></div></td>
        </tr>
      <tr >
        <td colspan="2" align="center" valign="top"><div align="center"><strong>มาตรา 33</strong></div></td>
      ...
      <tr >
        ...
        <td align="center"  valign="top"><div align="center">
          <p><strong>อัตราส่วน<br />
            ที่รับจริง<br />
          เปรียบเทียบ<br />
          กับที่ต้องรับ</strong><strong>(%) </strong></p>
        </div></td>
        <td align="center"  valign="top"><div align="center"><strong>คนพิการ<br>
        (ราย) </strong></div></td>
...
(บาท)</strong></td>
      ...
      <tr >
        ...
        <td colspan="14"  valign="top"><div align="left"><strong>ปฏิบัติตามกฎหมายครบตามอัตราส่วน</strong></div></td>
        </tr>
      </thead>
				...
				$choice_prefix = ""; //remove prefix
			 	...
			 	?>
                  <tr>
                    ...
                    <td align="right"  <?php echo $footer_row?>><div align="right"><strong><?Php echo round($sum_emp/$total_all_ratio*100,2);?>%</strong></div></td>
      ...
      <tr>
        ...
        <?Php 
			...
			//yoes 20180108
			if($this_emp > 0){
				echo round($this_emp/$all_ratio*100,2) . "%";
			}else{
				echo "-";
			}
...
<?php 
	...
	//yoes 20170724 -- end data for Company - keep the variables here
	$company_total_all_ratio = $total_all_ratio;
	$company_sum_emp = $sum_emp;
	$company_total_curator_usee = $total_curator_usee;
	$company_total_curator_user = $total_curator_user;
	$company_total_all_34 = $total_all_34;


	$total_all_ratio = 0;
	$sum_emp = 0;
	$total_curator_usee = 0;
	$total_curator_user = 0;
	$total_all_34 = 0;
...
<?php $business_type = "หน่วยงานภาครัฐ";
//}


//yoes 20170706 -- something about this GOV typecode
$typecode_filter = generateReportTypecodeFilterSQL($_POST[report_level]);
...
<table border="1" align="center" cellpadding="5" cellspacing="0" style="font-size:14px; display: none">
      ...
      <tr >
        <td  rowspan="4" align="center"  >          <div align="center" style="vertical-align:middle;"><strong>ลำดับที่ </strong></div></td>
        <td  rowspan="4" align="center"  >          <div align="center" style="vertical-align:middle;"><strong>รายการ</strong> </div></td>
        <td colspan="8" align="center" ><div align="center"><strong>หน่วยงานภาครัฐ</strong></div></td>
        </tr>
      <tr >
        <td  colspan="2" rowspan="2" align="center" valign="top"><div align="center"><strong>จำนวน<br>
        หน่วยงานภาครัฐ</strong></div></td>
        <td rowspan="3" align="center" valign="top" >
        ...
        <div align="center"><strong>
          ...
          รับคนพิการเข้า<br />
          ทํางาน(ราย) </strong></div>        </td>
        <td colspan="5" align="center" valign="top" ><div align="center"><strong>การปฏิบัติตามกฎหมาย </strong></div></td>
        </tr>
      <tr >
        <td colspan="2" align="center" valign="top"><div align="center"><strong>มาตรา 33</strong></div></td>
        <td colspan="3" align="center" valign="top"><div align="center"><strong>มาตรา 35</strong></div></td>
      ...
      <tr >
        <td  valign="top"><div align="center"><strong>1</strong></div></td>
        <td colspan="9"  valign="top"><div align="left"><strong>ปฏิบัติตามกฎหมายครบตามอัตราส่วน</strong></div></td>
        </tr>
      </thead>
 ...
 <table border="1" align="center" cellpadding="5" cellspacing="0" style="font-size:14px; ">
   	  <thead>
          ...
          <tr >
            <td  align="center"  ><div align="center" style="vertical-align:middle;">ต้องจ้าง</div></td>
            <td  align="center"  ><div align="right"> <?php echo formatEmployeeReport($company_total_all_ratio);?></div></td>
            <td  align="center"  >-</td>
            <td  align="center"  ><div align="center" style="vertical-align:middle;">ต้องจ้าง</div></td>
            <td  align="center"  ><div align="right"> <?php echo formatEmployeeReport($total_all_ratio);?></div></td>
            <td  align="center"  >-</td>
          </tr>
          <tr >
            <td  align="center"  ><div align="center" style="vertical-align:middle;">จ้างงาน ม.33</div></td>
            <td align="right" ><div align="right"><?php echo formatEmployeeReport($company_sum_emp);?></div></td>
            <td align="right" ><div align="right"><?Php 			
													echo round($company_sum_emp/$company_total_all_ratio*100,2);
													
													$sum_company_ratio += round($company_sum_emp/$company_total_all_ratio*100,2);
													
													
													?>%</div></td>
            <td  align="center"  ><div align="center" style="vertical-align:middle;">จ้างงาน ม.33</div></td>
            <td align="right" ><div align="right"><?php echo formatEmployeeReport($sum_emp);?></div></td>
            <td align="right" ><div align="right"><?Php 			
													echo round($sum_emp/$total_all_ratio*100,2);
													
													$sum_gov_ratio += round($sum_emp/$total_all_ratio*100,2);
													
													
													?>%</div></td>
          </tr>
          <tr >
            <td  align="center"  ><div align="center" style="vertical-align:middle;">สัมปทาน ม.35</div></td>
            <td  align="center"  ><div align="right"><?Php echo formatEmployeeReport($company_total_curator_usee+$company_total_curator_user);?></div></td>
            <td  align="center"  ><div align="right"><?Php 
			
												echo round(($company_total_curator_usee+$company_total_curator_user)/$company_total_all_ratio*100,2);
												
												$sum_company_ratio += round(($company_total_curator_usee+$company_total_curator_user)/$company_total_all_ratio*100,2);
												
												?>%</div></td>
            <td  align="center"  ><div align="center" style="vertical-align:middle;">สัมปทาน ม.35</div></td>
            <td  align="center"  ><div align="right"><?Php echo formatEmployeeReport($total_curator_usee+$total_curator_user);?></div></td>
            <td  align="center"  ><div align="right"><?Php 
			
												echo round(($total_curator_usee+$total_curator_user)/$total_all_ratio*100,2);
												
												$sum_gov_ratio += round(($total_curator_usee+$total_curator_user)/$total_all_ratio*100,2);
												
												?>%</div></td>
          </tr>
          <tr >
            <td  align="center"  ><div align="center" style="vertical-align:middle;">ส่งเงิน ม.34</div></td>
            <td  align="center"  ><div align="right"><?php echo formatEmployee($company_total_all_34)?></div></td>
            <td  align="center"  ><div align="right"><?Php 
											echo round(($company_total_all_34)/$company_total_all_ratio*100,2);
          ...
          <tr >
            <td  align="center"  ><div align="center" style="vertical-align:middle;">ร้อยละที่จ้างแล้ว<br />
            (ม.33 และ ม.35)</div></td>
            <td  align="center"  colspan="2" ><?Php echo round($sum_company_ratio,2);?>%</td>
            
            <td  align="center"  ><div align="center" style="vertical-align:middle;">ร้อยละที่จ้างแล้ว<br />
              (ม.33 และ ม.35)</div></td>
             <td  align="center"  colspan="2" ><?Php echo round($sum_gov_ratio,2);?>%</td>
            
          </tr>
          <tr >
            <td colspan="3"  align="center"  ><div align="center" style="vertical-align:middle;"> <strong>ยอดรวมการจ้างคนพิการเข้าทำงาน ม.33 การส่งเงินเข้ากองทุนฯแทนการรับคนพิการ ม.34 การให้สัมปทานฯ ม.35
            <br />
            (เอกชน)
            </strong> </div></td>
          ...
          <tr >
            <td colspan="3"  align="center"  >คิดเป็นจำนวน <?php 
			
						
						echo formatEmployeeReport($company_sum_emp+$company_total_curator_usee+$company_total_curator_user+$company_total_all_34)
						
			?> คน</td>
           
          </tr>
          <tr >
            <td colspan="3"  align="center"  >ร้อยละ <?php 
				
				echo $sum_company_ratio += round(($company_total_all_34)/$company_total_all_ratio*100,2);
