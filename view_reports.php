        ...
        <table style="margin:0px 0 0 20px;" cellspacing="20" id="two">
            ...
            <!--
                    ...
                    <tr>
                      ...
                      <a href="#" onclick="toggleReport(262); return false;">
                      ...
                      <table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td><?php include "ddl_org_province_report.php";?></td>
                            <td>รูปแบบ
                              <select name="report_format" id="report_format_262" onchange="toggleAction(262); return false;">
                                  <option value="html">html</option>
                            ...
                            <td><input name="input5" type="submit" value="เรียกดูรายงาน" />
                                <input type="hidden" name="the_report" id="the_report"  value="report_262"/></td>
                          </tr>
                          <?php if($sess_accesslevel == 1 || $sess_accesslevel == 2){?>
                          <tr>
                            <td>&nbsp;</td>
