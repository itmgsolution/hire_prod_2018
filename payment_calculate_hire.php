...
<option <?php if($_POST['Province']==76){?>selected='selected'<?php }?> value='76'>นราธิวาส</option>
   ...
   <table cellpadding="3" style="margin:0px 0 0 20px; border-collapse:collapse;<?php if(!$_POST["final_value"]){?>display: none;<?php }?>" border="1" cellspacing="0"  >
                	  <tr>
                	    ...
                	    <td colspan="4" align="center" style="text-align: center">รายละเอียดการส่งเงิน</td>
     </tr>
                	  <tr>
                	    <td align="center" style="text-align: center">จ่ายเงินต้น</td>
                	    <td align="center" style="text-align: center">ดอกเบี้ย</td>
                	    <td align="center" style="text-align: center">จำนวนวัน<br />ที่คิดดอกเบี้ย (วัน)</td>
						...
						?>
                         ...
                         <tr>
                           ...
                           <td><?php 
                            ...
                            <span id="<?php echo $ii;?>_start_money_part">
                            ...
                            <td style="text-align: right">
                            	...
                            	<span id="<?php echo $ii;?>_interest_money_days">
									  0
                              </span>
                            	<input type="hidden" id="<?php echo $ii;?>_interest_days" value="0" size="5" />
...
<script>
	...
	function check_ddl_values(what){
		...
		if(this_day > 0 && this_month >= 0 && this_year > 0){
			...
			<?php if($the_year >= 2018){ ?>
				var penalty_date = new Date (<?php echo $the_year;?>, 2, 31);
			<?php }else{ ?>			
				var penalty_date = new Date (<?php echo $the_year;?>, 0, 31);
			<?php } ?>
			...
			document.getElementById(what + "_interest_money_days").innerHTML = interest_days;
			document.getElementById(what + "_interest_days").value = interest_days;
			...
			var interest_money_to_show = $("#"+what+ "_interest_money_to_show").text().replace(/,/g, '');
			var start_money_part = $("#"+what+ "_start_money_part").text().replace(/,/g, '');
			var summed = +interest_money_to_show + +start_money_part;
			
			$("#"+what+ "_total_money_to_show").html(commaSeparateNumber(summed));
