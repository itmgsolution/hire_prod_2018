...
ที่เข้าข่ายต้องปฏิบัติตามกฎหมาย แต่มีการปฏิบัติตามกฎหมายแล้ว และจะไม่ถูกนำเข้าระบบ</td>
                        ...
                        <?php if(1==0){?>
                         <tr>
                       	   <td bgcolor="#efefef">
                            จำนวนสถานประกอบการ(สาขาหลักเท่านั้น)<br />ที่เข้าข่ายต้องปฏิบัติตามกฎหมาย และจะถูกนำเข้าระบบ
                            </td>
                            <td>
                            <div align="right">
                             <?php
						   
							   echo formatEmployee(getFirstItem("select count(*) from company_temp_all where is_in_case = 1 and BranchCode < 1"));
