                            ...
                            <td><table border="0" style="padding:10px 0 0 50px;" >
                              ...
                              <tr>
                                ...
                                <?php 
									...
									$hire_numofemp =  getHireNumOfEmpFromLid($lawfulness_row["LID"]);
									...
									if($lawfulness_year >= 2018 && $lawfulness_year < 2050){
					
										$employees_ratio = $need_for_lawful;
										$m33_total_reduction = get33DeductionByCIDYear($lawfulness_row[CID], $lawfulness_year);	
										
										
										
										$the_33 = $deducted_33/($year_date*$the_wage);
										//echo $the_33; exit();
                                ...
                                <span id="calculated_34_table">
                                    <table >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <div align="right">
                                            <?php echo $employees_ratio;?> x <?php 
                              ...
                              <tr>
                                ...
                                <td colspan="3"><?php 
									...
									if($the_amount){
										$pay_for_interest = ($interest_money); // - $the_amount
									}else{
										$pay_for_interest = 0;	
									}
                              ...
                              <tr>
								...
								if($extra_paid){
									...
									echo "<font color='green'>(จ่ายเงินเกิน ".number_format($extra_paid,2)." บาท)</font>";	
								...
								if($missing_paid){
									...
									echo "<font color='red'>(จ่ายเงินขาด ".number_format($missing_paid,2)." บาท)</font>";	
                          ...
                          <tr>
                            ...
                            <hr />
                              <div align="center">
                                ...
                                <input name="invoice_owned_interest" type="hidden" value="<?php echo $interest_money*1?>" />
