...
<div align="center">
            <strong>รายละเอียดการปฏิบัติตามกฎหมาย ม.34 และ ม.35 <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?></strong>
              <br>
</div>
    ...
    <table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:28px;"<?php }?>>
   	  <thead>
      <tr>
        <td colspan="13" align="center" valign="top"><div align="center"><strong><?php echo $business_type;?></strong></div></td>
      </tr>
      <tr >
        ...
        <td width="127" rowspan="2" align="center" valign="middle"><div align="center" style="vertical-align:middle;"><strong>ชื่อ<?php echo $business_type;?></strong> </div></td>
        <td width="178" rowspan="2" align="center" valign="middle"><div align="center" style="vertical-align:middle;"><strong>ที่อยู่</strong> </div></td>
  ...
  ?>
      <tr>
        ...
        <td width="127" valign="top"><div align="left"><?php echo $company_name_array[$i];?></div></td>
        <td width="178" valign="top"><div align="left"><?php echo $address_array[$i];?></div></td>
        ...
        <?php 
			...
			$employees_ratio = $employees_ratio - $sum_user_usee;
			$year_date = $year_date;
			$the_wage = $the_wage;
        ...
        <td width="100" align="right" valign="top"><?php echo $sum_user_usee; $total_sum_user_usee += $sum_user_usee;?></td>
      </tr>
      <?php
		  $holder_amount = 0;
		$holder_text = "";
  ...
  ?>
        ...
        <tfoot>
      <tr>
        <td width="355" colspan="5" align="right" ><div align="right"><strong>รวมทั้งสิ้น</strong></div></td>
        <td width="100" align="right" style="border-bottom:double;" ><strong>
        <?php 	
        ...
        <td width="100" align="right" style="border-bottom:double;" >
          <strong>
          <?php 
		...
		?></strong></td>
        <td width="100" align="right" style="border-bottom:double;" ><div align="right"><strong><?php echo formatMoney($the_sum_amount);?></strong> </div></td>
        ...
        <td width="100" align="right" style="border-bottom:double;" ><div align="right"><strong><?php echo formatEmployee($total_sum_user_usee);?></strong></div></td>
      </tr>
      </tfoot>
</table>
