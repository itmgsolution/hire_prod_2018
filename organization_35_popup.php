<div id="35_popup" style=" position:absolute; padding:3px; background-color:#006699; width: 1000px; <?php if(1==1){?>display:none;  <?php }?>" >
        		 ...
        		 <table id="curator_input_forms" style="display: block;">
                    ...
                    <tr>
                        ...
                        <tr id="tr_curator_docfile_3">
                         <td valign="top">สำเนาสัญญาสัมปทาน<br />
                         และสำเนาบัตรประจำตัวคนพิการ</td>
                          <td colspan="3">
