                        ...
                        <tr>
                          ...
                          <table border="0" style="padding:0px 0 0 50px;" >
                              ...
                              <tr id="tr_result2" style="display: none;">
                                ...
                                <td colspan="3"><span id="span_org_name" style="font-weight: bold;"><?php echo $registered_org_row["CompanyNameThai"];?></span></td>
                            ...
                            <?php }?>
                             ...
                             <?php if($mode == "edit"){?>
                              ...
                              <tr>
                                <td colspan="4"><hr />
                                <strong>ข้อมูลกรรมการบริษัท</strong></td>
                              </tr>
                              ...
                              <tr>
                               ...
                               <tr  >
                                 <td valign="top" style="padding:5px;">
                                  ...
                                  <img id="re02" src="exclaim_small.jpg" title="กรุณาแนบไฟล์"  height="15" />
                                 
                                หนังสือมติที่ประชุมคณะกรรมการที่ให้รายงานการปฏิบัติตามกฎหมายจ้างงานคนพิการผ่านทางอิเล็กทรอนิกส์
                              	...
                              	<?php if($mode == "edit"){?>
									...
									<?php if($required_doc){?>
                                     ...
                                     <div align="center" style="padding: 5px;" id="register_bottom_message">
                                      		<font color="#FF6600">กรุณากรอกข้อมูลบริษัท และแนบหลักฐานประกอบให้ครบถ้วน</font> - เจ้าหน้าที่จะอนุมัติผู้ใช้งานที่ข้อมูลครบถ้วนเท่านั้น
                                       </div>
                                                            
                                      
                                    
                                    <?php }elseif(!$no_pass && !$required_doc){?>
                                    
                                        <div align="center" style="padding: 5px;" id="register_bottom_message">
                                        		<font color="#009900">ระบบได้รับข้อมูลใบสมัครของท่านเรียบร้อยแล้ว</font> - กรุณารอการตรวจสอบเอกสาร และรอการอนุมัติจากเจ้าหน้าที่
                                         </div>
