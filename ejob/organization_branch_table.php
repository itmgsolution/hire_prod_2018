...
<table cellpadding="3" style="border-collapse:collapse;" border="1">
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                <div align="right">
                                                   <input id="exit" type="reset" name="form1:exit" value=" ปรับปรุงข้อมูล " onclick="window.location.href='organization.php?<?php echo $this_id;?>&focus=lawful';" style="width: 115px" />
                                                </div>
