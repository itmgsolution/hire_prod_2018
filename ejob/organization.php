<?php
	...
	//yoes 20160402 for company -> case never closed
	$case_closed = 0;
...
*</td>
                                  ...
                                  <td valign="top">
                                  	...
                                  	<div align="center">
                                       ...
                                       <?php 
											...
											if($submitted_row[lawful_submitted] == 1 || $submitted_row[lawful_submitted] == 2){
												...
												echo "<br><font color='#003300'>มีการยื่นแบบฟอร์มออนไลน์ไปเมื่อวันที่ ".formatDateThai($submitted_row[lawful_submitted_on],1, 1) ."</font>";
											...
											if($submitted_row[lawful_submitted] == 2){
												...
												echo "<br><font color='#003300'>เจ้าหน้าที่ทำการบันทึกข้อมูลเข้าระบบแล้วเมื่อวันที่ ".formatDateThai($submitted_row[lawful_approved_on],1, 1) ."</font>";
                                    ...
                                    <td valign="top">
                                    	...
                                    	<div align="center"><?php 
											...
											//yoes 20161006
											//sepcial on eserveice -> only shows "lawful" if actually lawful and case closed
											if($lawful_row[close_case_date] > $lawful_row[reopen_case_date]){
												$case_closed = 1;																		
											}
												
											if($lawful_row["LawfulStatus"] == 1 && !$case_closed){
												
												//echo "<img src='decors/yellow.gif' border='0' alt='กำลังดำเนินงาน' title='กำลังดำเนินงาน'/>";
												echo "<img src='decors/green_grey.gif' border='0' alt='เจ้าหน้าที่นำข้อมูลเข้าระบบแล้ว อยู่ระหว่างการตรวจสอบข้อมูลเพื่อปิดงาน' title='เจ้าหน้าที่นำข้อมูลเข้าระบบแล้ว อยู่ระหว่างการตรวจสอบข้อมูลเพื่อปิดงาน'/>";
			...
			<?php
				//yoes 20180222 --> reset case close flag safter the fact
				$case_closed = 0;
			?>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <?php 
															...
															if($sess_accesslevel == 4){
																...
																//yoes 20160402 --> change this to more corrected version
																$sqll = "select 
																								LID
																							from 
																								lawfulness
																...
																if(!$lid_existed){
																	...
																	if(strlen($lawful_values["LID"]) < 1){
																		...
																		//echo $sql; exit();
																		//echo "insert not";
																		//mysql_query($sql) or die(mysql_error()); exit();
																		
																		//$lid_count_result = mysql_query($sql);
																		
																		//echo $lid_count_result; exit();
																		...
																		if($lid_count_result){
																			...
																			//yoes 20160402 ....
																			$lawful_values["LID"] = getFirstItem("
																					select 
																						lid 
																					from 
																						lawfulness
																	...
																	//yoes 20160912 -> "real lawfulness" existed -> see if company verson have it -> if not create it
																	
																	$lawful_values["LID"] = $lid_existed;
																	...
																	$lid_company_existed = getFirstItem($sqll);
																	
																	//echo $sqll; exit();
																	
																	
																	
																	if(!$lid_company_existed){
                                            ...
                                            <tr >
                                              <td colspan="3">
                                                ...
                                                <font color="#006600">
                                                    ...
                                                    <br />
                                                    <font style="font-size:11px;">เป็นไฟล์ jpg, gif, png หรือ pdf เท่านั้น</font>
                                                </font>
...
<table border="0">
  ...
  <tr>
    ...
    <?php if($sess_accesslevel == 4 && !$submitted_company_lawful){?>
    <a href="#" onClick=" fireMyPopup('35_popup',800,500); document.getElementById('curator_form').reset(); return false;" style="font-size: 16px; ">+ข้อมูลผู้ใช้สิทธิมาตรา 35 คลิกที่นี่</a>
    <?php }?>
...
<?php }?>
 ...
 <?php if($curator_user && 1==0){ //yoes 20160402 --- show attachment if have some 35 // yoes 20160427 -- no longer need this?>
            ...
            <table border="0" >
                    ...
                    <tr >
                      <td colspan="3">
                        ...
                        <br />
                        <font color="#006600">
                            <strong>เอกสารประกอบการรายงาน มาตรา 35</strong>
                        </font>
                    ...
                    <tr bgcolor="#fcfcfc" >
                    <td>
                        <img id="ex351" src="exclaim_small.jpg" title="กรุณาแนบไฟล์" style="padding: 5px;" />
                      </td>
                      <td>
                        สำเนาหนังสือแจ้งขอใช้สิทธิ
                      </td>
                      <td>
                        ...
                        <?php 
                            ...
                            $file_type = "company_35_docfile_1";
                        
                            include "doc_file_links.php";
                           
                            
                        ?>
                        <?php if($have_doc_file){$required_doc--;?><br /><script>$('#ex351').hide();</script><?php }?>
                       <input type="file" name="company_35_docfile_1" id="company_35_docfile_1" />
                      </td>
                    </tr>
                    
                   <tr >
                     <td>
                        <img id="ex352" src="exclaim_small.jpg" title="กรุณาแนบไฟล์" style="padding: 5px;" />
                      </td>
                          <td>
                            สำเนาหนังสือแจ้งผลการดำเนินการ
                            <br />
                            (หากไม่นำมา ถือว่ายังไม่ปฏิบัติตามกฎหมาย)
                          </td>
                          <td>
                            <?php 
                              
							  	$required_doc++;
                                $file_type = "company_35_docfile_2";
                                include "doc_file_links.php";
                             
                            ?>
                            <?php if($have_doc_file){$required_doc--;?><br /><script>$('#ex352').hide();</script><?php }?>
                           <input type="file" name="company_35_docfile_2" id="company_35_docfile_2" />
                          </td>
                        </tr>
                    
                     <tr bgcolor="#fcfcfc">
                         <td>
                        <img id="ex353" src="exclaim_small.jpg" title="กรุณาแนบไฟล์" style="padding: 5px;" />
                      </td>
                          <td>
                           สำเนาสัญญาสัมปทาน<br />หรือสำเนาบัตรประจำตัวคนพิการ
                          </td>
                          <td>
                            <div style="width: 250px">
                            <?php                                              
								...
								$required_doc++;
                                $file_type = "company_35_docfile_3";                                                
                                include "doc_file_links.php";                                                    
                                $this_id = $this_id_temp;
                                                                                    
                            ?>
                            <?php if($have_doc_file){$required_doc--;?><br /><script>$('#ex353').hide();</script><?php }?>
                           <input type="file" name="company_35_docfile_3" id="company_35_docfile_3" /> 
 ...
 <?php } //ends if($curator_user){ //yoes 20160402 --- show attachment if have some 35?>
        ...
        <tr>
			...
			?></strong> บาท/วัน</td>
                  ...
                  <tr>
                     ...
                     <?php 
						 //yoes 20160816
						 if(strtotime($this_date_time) < strtotime(date("Y-m-d"))){
							 
							 $m34_is_lower_date = 1;
							 
							 //echo  $m34_is_lower_date;
...
<!----------------------->
                                  ...
                                  <td colspan="2"><div align="center">
                                      ...
                                      <?php }else{ //if sess_accesslevel == 4 ?>
                                              ...
                                              <?php if(!$submitted_company_lawful){?>
                                                ...
                                                <?php 
													//echo $required_doc;
													if($required_doc || $m34_is_lower_date){
												?>
                                                
                                                	<?php if($required_doc){?>
                                                     <div align="center" style="padding: 5px;">
                                                        <font color="#FF6600" >ไม่อนุญาตให้ยื่นแบบฟอร์ม เนื่องจากยังแนบเอกสารไม่ครบ</font> - กรุณาทำการตรวจสอบข้อมูลก่อนยื่นแบบฟอร์ม
                                                        </div>
                                                    <?php }?>
                                                    
                                                    
                                                    <?php if($m34_is_lower_date){?>
                                                     <div align="center" style="padding: 5px;">
                                                        <font color="#FF6600" >ไม่อนุญาตให้ยื่นแบบฟอร์ม เนื่องจากวันที่ต้องการชำระเงินตามมาตรา 34 เป็นวันที่ผ่านมาแล้ว</font> - กรุณาทำการตรวจสอบข้อมูลก่อนยื่นแบบฟอร์ม
                                                        </div>
                                                    <?php }?>
                                                        
                                                       <input name="" type="button" value="ยื่นแบบฟอร์มออนไลน์" disabled="disabled" />
                                                       
                                                   <?php }else{?>
                                                    
                                                 		 <input type="button" name="submit_doc" id="submit_doc" value="ยื่นแบบฟอร์มออนไลน์" />
                                                         
                                                         <div id="js_doc_warning" style="display:none;">
                                            ...
                                            <script>                                        
                                                ...
                                                document.getElementById('submit_doc').onclick = function() {
                                                    ...
                                                    if(confirm('การยื่นเอกสารออนไลน์  หลังจากยื่นแล้วจะไม่สามารถกลับมาแก้ไขข้อมูลผ่านระบบออนไลน์ได้อีก กรุณาตรวจสอบความถูกต้องก่อนทำการยื่นเอกสารออนไลน์')){
                  ...
                  <?php 
					...
					if($submitted_company_lawful ){
                        ...
                        <div align="center" style="color: #060">
                        	มีการยื่นแบบฟอร์มออนไลน์ไปแล้ว เมื่อวันที่ <?php 
				 ...
				 <?PHp		
				  ...
				  ?>
					  ...
					  <?php if(($this_lawful_year == 2016 || $this_lawful_year == 2017 || $this_lawful_year == 2018) && ($sess_accesslevel == 4)){ // yoes20151025 - add form จพ-xx?>
                            ...
                            <form method="post" action="./create_pdf_4.php" target="_blank">
                        		...
                        		<?php if($submitted_company_lawful == 0){?>
                                	...
                                	<?php //yoes 20170102 --- hid preview for now 
			...
			<script language='javascript'>
						...
						function validateFormBranch(frm) {
						   ...
						   if (!allValid)
						   {
							...
							if(frm.Subdistrict.value.length < 1)
							{
								alert("กรุณาใส่ข้อมูล: ตำบล/แขวง");
								frm.Subdistrict.focus();
								return (false);
							}
							
							if(frm.District.value.length < 1)
							{
                                        ...
                                        <?php }?>
                                         >
                                          ...
                                          <tr>
                                          		...
                                          		<td>
                                            	สำเนาสัญญาจ้าง  <br /><font style="font-size:11px;">เป็นไฟล์ jpg, gif, png หรือ pdf เท่านั้น</font></td>
                                                ...
                                                <td  >
                                                 ...
                                                 <br /><font style="font-size:11px;">เป็นไฟล์ jpg, gif, png หรือ pdf เท่านั้น</font></td>
													...
													?>
                                                	 <input type="file" name="docfile_33_2" id="docfile_33_2" 
                                                     	<?php if(!$have_doc_file){?>required="required"<?php }?>/>
