           ...
           <div align="center">
            ...
            ?>
				...
				if($the_user_name && $the_user_row[user_enabled] == 2){
					...
					$the_back_link = "http://ejob.dep.go.th/ejob/view_register.php?p=".htmlentities(base64_encode($this_id))."&n=".htmlentities(base64_encode(doCleanInput($this_register_name)))."&r=1";
