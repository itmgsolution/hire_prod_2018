                ...
                >
                  ...
                  <?php }elseif($sess_user_enabled == "0"){?>
                   <div align="center" style="background-color: #F0FFF8; color:#006600; width:500px; padding: 5px; text-align: left;">
                    ...
                    3) หลังจากกรอกข้อมูลครบถ้วน และเจ้าหน้าที่ได้ทำการอนุมัติการใช้งานแล้ว จะมีอีเมล์แจ้งไปหาท่านอีกครั้ง
                             ...
                             <?php if($mode == "edit"){?>
                              ...
                              <tr>
                               ...
                               <tr bgcolor="#fcfcfc" >
                                 ...
                                 <a href="3_sign_form.pdf" target="_blank" style="font-weight: normal">(download แบบฟอร์ม)</a>
                                 </td>
                              ...
                              <div align="center">
                                ...
                                <?php if($required_doc){?>
                                 ...
                                 <div align="center" style="padding: 5px;">
                                                        <font color="#FF6600">กรุณาแนบเอกสารให้ครบถ้วน</font> - เจ้าหน้าที่จะอนุมัติผู้ใช้งานที่ข้อมูลครบถ้วนเท่านั้น
                                                        </div>
