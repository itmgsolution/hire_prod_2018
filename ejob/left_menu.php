...
<div id="pageNav"> 
	...
	//yoes 20160331 - open this for ejob
	if(1==1){  
	?>
    ...
    <div style="font-weight: bold; padding:5px 5px 5px 10px; color:#006699">
    	คู่มือการใช้งาน
    </div>
    
    <div id="sectionLinks">
         <a href="hire_eservice_manual_for_company.pdf"  style="margin-left:10px; font-weight: normal;"> 
