<?php
	...
	if($_GET[p] && $_GET[n]){
		...
		$sqll = "select * from users where user_id = '$decoded_id' and user_name = '$decoded_name' and user_enabled in (9)";
		//echo $sqll;
	...
	if($sess_user_enabled == "0" || $sess_user_enabled == 2){
		...
		//no password
		if(strlen($register_values[user_password])==0){
			$no_pass = 1;
		}
