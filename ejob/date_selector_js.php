...
<select name="<?php echo $selector_name;?>_day" size="1" class="inputf" id="<?php echo $selector_name;?>_day" style="width:auto;"
    ...
    >
                                              ...
                                              <select name="<?php echo $selector_name;?>_year" size="1" class="inputf" id="<?php echo $selector_name;?>_year" style="width:auto;" 
        ...
        onChange="reCalculateAllValues();"                                      	
                                               ...
                                               if(date("m") >= 8){
													$this_date_selected_year = date("Y")+1; //new year at month 9
												}else{
													$this_date_selected_year = date("Y");
												}
                                                $end_year = 2007;
                                                
                                                for($i=$this_date_selected_year; $i >= $end_year; $i--){
                                                    echo "<option value=\"".("$i") ."\"";
                                                    if($this_selected_year == $i){
