<?php 
	...
	$the_back_link = "http://203.154.94.105/ejob/view_register.php?p=".htmlentities(base64_encode($this_id))."&n=".htmlentities(base64_encode(doCleanInput($this_register_name)));
