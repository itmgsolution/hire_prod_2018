<div id="35_popup" style=" position:absolute; padding:3px; background-color:#006699; width: 800px; <?php if(1==1){?>display:none;  <?php }?>" >
                    ...
                    <tr>
                            ...
                            <td>
                                ...
                                value="<?php echo $curator_row_to_fill["curator_idcard"];?>" style="display:none;"
                                 ...
                                 <?php include "txt_id_card.php";?> <font color="red">*</font>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="curator_age" type="text" id="curator_age" size="10" maxlength="2"  value="<?php echo $curator_row_to_fill["curator_age"];?>" /> <font color="red">*</font></td>
                        </tr>
                        ...
                        <tr id="tr_curator_docfile">
                         <td valign="top">สำเนาหนังสือแจ้งขอใช้สิทธิ<br /><font style="font-size:11px;">เป็นไฟล์ jpg, gif, png หรือ pdf เท่านั้น</font></td>
                          <td colspan="3">
                        ...
                        <tr id="tr_curator_docfile_2">
                         <td valign="top">สำเนาหนังสือแจ้งผลการดำเนินการ <br />(หากไม่นำมา ถือว่ายังไม่ปฏิบัติตามกฎหมาย)<br /><font style="font-size:11px;">เป็นไฟล์ jpg, gif, png หรือ pdf เท่านั้น</font></td>
                          <td colspan="3">
                        ...
                        <tr id="tr_curator_docfile_3">
                         <td valign="top">สำเนาสัญญาสัมปทาน<br /><font style="font-size:11px;">เป็นไฟล์ jpg, gif, png หรือ pdf เท่านั้น</font></td>
                          <td colspan="3">
                        ...
                        <tr  id="usee_row_4">
                          ...
                          <td>อายุ</td>
                          <td>
                          <input name="usee_age" type="text" id="usee_age" size="10"  value="<?php echo $usee_row_to_fill["curator_age"];?>" /> <font color="red">*</font>
                          </td>
                        </tr>
                        <tr  id="usee_row_5">
                          <td valign="top">ลักษณะความพิการ</td>
						...
						<tr >
											<td colspan="4">
												...
												<div align="center">
													<form method="post" action="scrp_import_last_curator.php"  onsubmit="return confirm('ต้องการนำเข้าข้อมูลงานจากปีที่แล้วมาใส่ในปีนี้?');">
    ...
    <script language='javascript'>
						...
						function validateCuratorForm(frm) {
						   ...
						   ///yoes 20160907 -- validate age
						   //
							if(frm.curator_age.value.length < 1 || frm.curator_age.value == "0.00" || (frm.curator_age.value+0) < 1)
							{
								alert("กรุณาใส่ข้อมูล: อายุ");
								frm.curator_age.focus();
								return (false);
							...
							if(document.getElementById('r1').checked){
								   ...
								   if (!allValid)
								   {
									...
									if(frm.usee_name.value.length < 1)
									{
									 ...
									 ///yoes 20160907 -- validate usee_age
									   //
										if(frm.usee_age.value.length < 1 || frm.usee_age.value == "0.00" || (frm.usee_age.value+0) < 1)
										{
											alert("กรุณาใส่ข้อมูล: อายุ");
											frm.usee_age.focus();
											return (false);
										...
										//check number a hardway
										var checkStr = frm.usee_age.value;
										var allValid = true;
										for (i = 0;  i < checkStr.length;  i++)
									   {
										 ch = checkStr.charAt(i);
