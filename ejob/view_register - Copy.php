                          ...
                          <table border="0" style="padding:0px 0 0 50px;" >
                              ...
                              <tr id="tr_textbox">
                                ...
                                <td><span class="style86" style="padding: 10px 0 10px 0;">
                                  <input name="register_org_code" type="text" id="register_org_code" maxlength="10" value="<?php echo $register_values["register_org_code"];?>"  />
                              ...
                              <tr id="tr_result" style="display: none;">
                                <td >เลขที่บัญชีนายจ้าง</td>
                                <td colspan="3"><span id="span_org_code" style="font-weight: bold;"></span></td>
                                
                              </tr>
                              <tr id="tr_result2" style="display: none;">
                                <td>ชื่อบริษัท (ภาษาไทย)</td>
                                <td colspan="3"><span id="span_org_name" style="font-weight: bold;"></span></td>
