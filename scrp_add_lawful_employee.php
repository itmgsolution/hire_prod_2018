<?php
	...
	$special_fields = array('le_start_date', 'le_end_date','le_wage', 'le_disable_desc');
	$special_values = array("'$le_date'" , "'$le_end_date'","'".deleteCommas($_POST["le_wage"])."'","'".doCleanInput($_POST["le_disable_desc_hire"])."'");
