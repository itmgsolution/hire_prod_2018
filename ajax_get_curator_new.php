<?php
	...
	// --- SOAP OVERIDE PROCESS START HERE ----------
	$username = 'jobdepgoth';
	$password = ']y[l6fpvf';

	$DEFORM_ID_2_NAME = array(
		1 => "ความพิการทางการเห็น",
		6 => "ความพิการทางการเห็น",
		12 => "ความพิการทางการเห็น",
		2 => "ความพิการทางการได้ยินหรือสื่อความหมาย",
		7 => "ความพิการทางการได้ยินหรือสื่อความหมาย",
		13 => "ความพิการทางการได้ยินหรือสื่อความหมาย",
		3 => "ความพิการทางการเคลื่อนไหวหรือร่างกาย",
		8 => "ความพิการทางการเคลื่อนไหวหรือร่างกาย",
		14 => "ความพิการทางการเคลื่อนไหวหรือร่างกาย",
		4 => "ความพิการทางจิตใจหรือพฤติกรรม หรือออทิสติก",
		9 => "ความพิการทางจิตใจหรือพฤติกรรม หรือออทิสติก",
		15 => "ความพิการทางจิตใจหรือพฤติกรรม หรือออทิสติก",
		5 => "ความพิการทางสติปัญญา",
		10 => "ความพิการทางสติปัญญา",
		16 => "ความพิการทางสติปัญญา",
		6 => "ความพิการทางการเีรียนรู้",
		11 => "ความพิการทางการเีรียนรู้",
		17 => "ความพิการทางการเีรียนรู้",
		18 => "ทางออทิสติก"
	);
	...
	if($result->return_code == 0){
		...
		$PERSON_CODE 			= $dat->person_code;
		$FIRST_NAME_THAI 	= $dat->first_name_thai;
		$LAST_NAME_THAI 	= $dat->last_name_thai;
		$SEX_CODE 				= $dat->sex_code;
		$BIRTH_DATE 			= sqlBirthday($dat->birth_date);
		$DEFORM_ID				= $DEFORM_ID_2_NAME[$dat->deform_id];
		$PREFIX_NAME_ABBR = $dat->prefix_name_abbr;
		$the_output =
	...
	$req->password = $password;
	$req->person_code = $the_id;
	$ws = new SoapClient("http://203.155.46.118/ws/services.php?func=02",array("trace" => 1, "exception" => 0));
	$result = $ws->getCurator($req);
	if($result->return_code == 0){
		// Curator Parent
		$PREFIX_NAME_ABBR			= $result->prefix_name_abbr;
		$FIRST_NAME_THAI			= $result->first_name_thai;
		$LAST_NAME_THAI				= $result->last_name_thai;
		$the_id								= $result->person_code;
		$the_curator_gender		= $result->sex_code;
		//$curator_lid					= "";
		$RELATION_OTHER				= $result->relation_other;
		//$curator_value = "";
		...
		// Curator Child
		$child = $result->maimad_details->maimad;
		$PREFIX_NAME_ABBR			= $child->prefix_name_abbr;
		$FIRST_NAME_THAI			= $child->first_name_thai;
		$LAST_NAME_THAI				= $child->last_name_thai;
		$PERSON_CODE					= $child->person_code;
		$SEX_CODE							= $child->sex_code;
		$BIRTH_DATE						= sqlBirthday($child->birth_date);
		//$curator_lid
		$DEFORM_ID						= $DEFORM_ID_2_NAME[$child->deform_id];
	...
	$BIRTH_DATE = sqlBirthday($BIRTH_DATE);
