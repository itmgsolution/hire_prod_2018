...
<div align="center">
            <strong>รายละเอียดการปฏิบัติตามกฎหมาย ม.33 และ ม.35 <?php echo $the_company_word;?> <?php echo $province_text;?> ประจำปี <?php echo $the_year_to_use;?></strong>
              <br>
</div>
    ...
    <table border="1" align="center" cellpadding="5" cellspacing="0" <?php if(!$is_pdf){?>style="font-size:14px;"<?php }else{?>style="font-size:28px;"<?php }?>>
   	  <thead>
      <tr>
        <td colspan="8" align="center" valign="top"><div align="center"><strong><?php echo $business_type;?></strong></div></td>
      </tr>
      <tr >
        ...
        <td width="127" rowspan="2" align="center" valign="top"><div align="center" style="vertical-align:middle;"><strong>ชื่อ<?php echo $business_type;?></strong> </div></td>
        <td width="178" rowspan="2" align="center" valign="top"><div align="center" style="vertical-align:middle;"><strong>ที่อยู่</strong> </div></td>
...
<br />
(ราย)</strong></div></td>
        <td width="200" colspan="2" align="center" valign="top" ><div align="center"><strong>ให้สัมปทานฯ ตามมาตรา 35</strong></div></td>
        </tr>
      <tr >
  ...
  ?>
      <tr>
        ...
        <td width="127" valign="top"><div align="left"><?php echo formatCompanyName($lawful_row["CompanyNameThai"],$lawful_row["CompanyTypeCode"]);?></div></td>
        <td width="178" valign="top"><div align="left"><?php echo $address_to_use;?></div></td>
  ...
  ?>
      ...
      <tr>
        ...
        <td width="100" align="right" style="border-bottom:double;" ><div align="right"><strong><?php echo formatEmployee($total_curator_usee);?></strong> </div></td>
        <td width="100" align="right" style="border-bottom:double;" ><div align="right"><strong><?php echo formatEmployee($total_curator_user);?><strong></strong></div></td>
      </tr>
      </tfoot>
</table>
