...
<table border="1" cellpadding="5" style="border-collapse:collapse;" >
  ...
  <tr>
    ...
    <td bgcolor="#E6F2FF"><?php 
		...
		if($invoice_row[invoice_owned_interest] - $invoice_row[invoice_interest_amount]){
		...
		echo number_format($invoice_row[invoice_owned_interest] - $invoice_row[invoice_interest_amount],2);
