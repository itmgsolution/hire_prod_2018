                          ...
                          <?php }?>    
								...
								<?php }else{?>
									  <td class="td_left_pad"> เลขที่ประจำตัวผู้เสียภาษีอากร: </td>
										<td><input type="text" name="TaxID" value="<?php echo $output_values["TaxID"];?>" maxlength="13" /></td>
								<?php }?>
                                                    ...
                                                    <table border="0" >
                                                         ...
                                                         <?php
																...
																if($this_lawful_year >= 2018 && $this_lawful_year < 2050){
																	...
																	$start_money = $final_employee*$wage_rate*$year_date;
																	
																	//$start_money_array = array();																	
																	//for($iiii = 0; $iiii < $final_employee; $iiii++){																		
																	//	$start_money_array[$iiii] = $wage_rate*$year_date;
																	//}
																	
																	//print_r($start_money_array);																	
																	$m33_total_reduction = get33DeductionByCIDYear($this_cid, $this_lawful_year);
																	
																	
																	//yoes 20180208 -> reduction money can't be more than start money																	
																	if($m33_total_reduction > $start_money){																		
																		$m33_total_reduction = $start_money;
																	}
                                                            ...
                                                            <table >
																...
																<?php if($this_lawful_year >= 2018 && $this_lawful_year < 2050){ ?>
																 <tr>
																	...
																	<font color='green'>
																		<?Php echo formatNumber($m33_total_reduction); ?>                                                        
																	</font>
                                         	 ...
                                         	 <td valign="top">
														  ...
														  <?php 
                                                            ...
                                                            ?>
                                                                ...
                                                                <a href="http://ejob.dep.go.th/ejob//hire_docfile/<?php echo $file_row["file_name"];?>" target="_blank">
												...
												function doGetSSOData(){
												   ...
												   if (!allValid)
												   {
													...
													$.ajax({
													  ...
													  data: { name: "John", location: "Boston", the_id: the_id, CompanyCode: <?php echo $output_values["CompanyCode"];?>}
													})
													  .done(function( html ) {
														//alert( "Data Saved: " + msg );
